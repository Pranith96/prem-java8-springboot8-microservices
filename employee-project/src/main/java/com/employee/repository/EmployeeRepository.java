...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
	...
	//@Query("select e from Employee e where e.loginId=:loginId and e.password=:password")
	...
	//@Query(value = "select * from employee_table where login_id=:loginId and password=:password",nativeQuery = true)
	//Optional<Employee> getByLoginIdAndPassword(String loginId, String password);
